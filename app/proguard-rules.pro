...
# Keep the foreground service entry point — it is referenced via the manifest by name and must
# survive shrinking/renaming.
-keep class com.pause.app.service.UsageAccessMonitorService { *; }
