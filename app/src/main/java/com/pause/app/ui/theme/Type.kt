...
// Platform default font family (no bundled fonts), tuned for a calm, editorial feel:
// generous display weights, comfortable body line-height, restrained letter spacing.
private val Default = FontFamily.Default

val PauseTypography = Typography(
    displayMedium = TextStyle(
        fontFamily = Default, fontWeight = FontWeight.Bold, fontSize = 40.sp, lineHeight = 46.sp, letterSpacing = (-0.6).sp,
    ),
    displaySmall = TextStyle(
        fontFamily = Default, fontWeight = FontWeight.Bold, fontSize = 32.sp, lineHeight = 38.sp, letterSpacing = (-0.5).sp,
    ),
